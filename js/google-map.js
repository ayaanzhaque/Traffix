function initMap() {
    ...
    var givenLatitude = parseInt(document.getElementById("stopLat").value);
    var givenLongitude = parseInt(document.getElementById("stopLong").value);
    ...
    var givenLatitude = parseInt(document.getElementById("speedLat").value);
    var givenLongitude = parseInt(document.getElementById("speedLong").value);
    ...
    var givenLatitude = parseInt(document.getElementById("lightLat").value);
    var givenLongitude = parseInt(document.getElementById("lightLong").value);
    ...
    function placeMarker(givenLat, givenLong, map, givenContent, givenIcons) {
